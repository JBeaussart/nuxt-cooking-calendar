          ...
          <div class="sm:col-span-2 flex flex-row items-end justify-between gap-4">
            ...
            <div class="flex items-center">
              <div class="flex items-center p-1 bg-stone-100 dark:bg-stone-800 rounded-xl border border-stone-200 dark:border-stone-700">
                ...
                <button type="button" @click="form.reception = !form.reception" class="px-3 sm:px-4 py-1.5 text-xs sm:text-sm rounded-lg transition-all flex items-center gap-1"
                  :class="form.reception ? 'bg-white dark:bg-stone-700 font-bold text-violet-600 shadow-sm' : 'font-medium text-stone-500 dark:text-stone-400'">
...
const form = reactive<{
  ...
  steps: string[];
}>({ title: "", image: "", salt: true, maman: false, reception: false, servings: 4, prepMinutes: "", ingredients: [], steps: [] });
